...
description: >-
  Use always when operating as Claude Fable on codebase-heavy or token-heavy
  work: Fable orchestrates, architects, synthesizes, and judges while cheaper
  subagents do bounded research, coding, testing, and log reduction.
---
...
Use `assets/fable-orchestrator.png` (rendered diagram) or
`assets/fable-orchestrator.excalidraw` (editable source) when a visual
explanation helps.
