...
description: >-
  Use before substantial work and between parallel agent waves — especially
  overnight batch runs or multi-wave parallel subagents that might exhaust the
  5-hour or weekly usage window — to check usage, pause near the cap, and
  resume only when the window is clear.
---
